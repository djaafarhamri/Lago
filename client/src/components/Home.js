    ...
    return {
        ...
        <div className='home'>
            <div className='nav'>
                ...
                {!name ? 
                    <div className='login'>
                        ...
                        {showInput && (
                        <>
                            <input type="text" placeholder="username" required ref={inputRef} onChange={(e) => {
            ...
            <div className="content">
                ...
                <Challengers setNewGame={setNewGame} times={times} challengers={challengers} setChallengers={setChallengers} />  
                {renderPlay}
                <Puzzles />
                {renderComputer}
                {newGame && <Newgame name={name} setNewGame={setNewGame}/>}
                {newComputerGame && <NewComputerGame setNewComputerGame={setNewComputerGame}/>}
            </div>    
        </div>
    )}
}
