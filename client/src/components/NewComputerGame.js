        ...
        <div className='newgame'>
            ...
            <div className='online_users'>
                ...
                <div className='slider'>
                    <p>computer level</p>
                    <Slider min={0} max={4} step={1} onChange={(value) => {setLevel(value)}}/>
                    <p>{level}</p>
                </div>
                <div className='timecontrol'>
                    <button 
                        style={orientation === 'white'?{background:'#7a3ffb', color:'white'}:{background:'white', color:'black'}} 
                        className='btn'
                        onClick={() => {setOrientation('white')}}
                        >WHITE</button>
                    <button 
                        style={orientation === 'black'?{background:'#7a3ffb', color:'white'}:{background:'white', color:'black'}} 
                        className='btn'
